...
#         self.anydesk_id = 0
#         try:
#             subprocess.run(["del", "anydes_id_f.txt"], shell=True, check=True)
#         except subprocess.CalledProcessError:
#             print("not deleted")
#         # anydesk_path = "C:\Program Files (x86)\AnyDesk\AnyDesk.exe"  # Adjust this path as needed
     
#         # Run AnyDesk command and capture output
#         # result = subprocess.run([anydesk_path, '--get-alias'], capture_output=True, text=True)
#         subprocess.run(["get_anydesk_id.bat"], stdout=open("anydes_id_f.txt", "w"), shell=True, check=True)
#         # if result.returncode == 0:
#         #     self.anydesk_id = result.stdout.strip()  # Get the output and strip any leading/trailing whitespace
#         #     print("self.anydesk_id:" + str(self.anydesk_id))
#         #     self.label_19.setText("<font color=blue> AnyDesk ID: </font> " + str(self.anydesk_id))
#         # else:
#         #     print("Failed to get AnyDesk ID")
#         #     self.label_19.setText("<font color=red> Failed to get AnyDesk ID </font>")
#         with open("anydes_id_f.txt", "r")as f:
#             for line in f:

#                 self.anydesk_id = line[15:]
#                 break
#         print("self.anydesk_id:" + str(self.anydesk_id))
#         self.label_19.setText("<font color=blue> AnyDesk ID: </font> " + str(self.anydesk_id))               
