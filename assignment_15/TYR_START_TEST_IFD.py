...
# Form implementation generated from reading ui file 'TYR_START_TEST_IFD.ui'
#
...
" Unit:"))
    ...
    def goForTest(self):
        ...
        if close == QMessageBox.Ok:
                if(self.go_ahead=="Yes"):
                        ...
                        self.show_grid_data()
                        self.label_10.setText("Please start the test......")
                        self.label_10.show()
        ...
        if(self.go_ahead=="Yes"): 
                ...
                if(self.test_id_exist=="Yes"):                   
                        ...
                        with connection:
                                ...
                                cursor.execute("UPDATE TEST_MST SET SPECIMEN_NAME = '"+str(self.comboBox_4.currentText())+"', JOB_NAME = '"+str(self.lineEdit_15.text())+"', BATCH_ID = '"+str(self.lineEdit_16.text())+"', MOTOR_SPEED = '"+str(self.lineEdit_9.text())+"', MOTOR_REV_SPEED = '"+str(self.lineEdit_10.text())+"', GUAGE_LENGTH = '"+str(self.lineEdit_12.text())+"', GRAPH_SCAL_Y_LOAD='"+self.lineEdit_14.text()+"', GRAPH_SCAL_X_LENGTH='"+self.lineEdit_13.text()+"', PRE_LOAD ='"+str(self.lineEdit_11.text())+"', WIDTH ='"+str(self.lineEdit_18.text())+"', THICKNESS ='"+str(self.lineEdit_17.text())+"', LAST_UNIT_LOAD = '"+str(self.comboBox_2.currentText())+"', LAST_UNIT_DISP = '"+str(self.comboBox_2.currentText())+"' WHERE  TEST_ID = '"+str(int(self.label_12.text()))+"'")
                                cursor.execute("UPDATE SPECIMEN_MST SET  LAST_UNIT_LOAD = '"+str(self.comboBox_2.currentText())+"', LAST_UNIT_DISP = '"+str(self.comboBox_2.currentText())+"', LOAD_CELL = '"+str(self.lineEdit_19.text())+"', MOTOR_SPEED = '"+str(self.lineEdit_9.text())+"', GUAGE_LENGTH_MM = '"+str(self.lineEdit_12.text())+"', THICKNESS = '"+str(self.lineEdit_17.text())+"', WIDTH = '"+str(self.lineEdit_18.text())+"', REV_MOTOR_SPEED = '"+str(self.lineEdit_10.text())+"', PRE_LOAD = '"+str(self.lineEdit_11.text())+"'  WHERE SPECIMEN_NAME = '"+str(self.comboBox_4.currentText())+"'")
                        ...
                        with connection:        
                                cursor = connection.cursor()                                                
                                cursor.execute("INSERT INTO TEST_MST(TEST_ID,SPECIMEN_NAME,JOB_NAME,BATCH_ID,MOTOR_SPEED,MOTOR_REV_SPEED,GUAGE_LENGTH,GRAPH_SCAL_Y_LOAD,GRAPH_SCAL_X_LENGTH,PRE_LOAD,WIDTH,THICKNESS,LAST_UNIT_LOAD,LAST_UNIT_DISP) VALUES('"+str(int(self.label_12.text()))+"', '"+str(self.comboBox_4.currentText())+"', '"+str(self.lineEdit_15.text())+"', '"+str(self.lineEdit_16.text())+"', '"+str(self.lineEdit_9.text())+"','"+str(self.lineEdit_10.text())+"', '"+str(self.lineEdit_12.text())+"', '"+self.lineEdit_14.text()+"', '"+self.lineEdit_13.text()+"', '"+self.lineEdit_11.text()+"', '"+str(self.lineEdit_18.text())+"' ,'"+str(self.lineEdit_17.text())+"','"+str(self.comboBox_2.currentText())+"','"+str(self.comboBox_3.currentText())+"')")
                                cursor.execute("INSERT INTO TEST_DATA_RADIAL(SPEC_ID,TEST_ID,LOAD_POINTS, D1_PER, D1, D2_PER, D2, D3_PER, D3, D4_PER, D4, LOAD_UNIT,LENGTH_UNIT) VALUES('"+str(self.label_26.text())+"', '"+str(self.label_12.text())+"', '"+str(self.comboBox.currentText())+"','"+self.lineEdit_37.text()+"','"+self.label_92.text()+"', '"+self.lineEdit_38.text()+"', '"+self.label_93.text()+"', '"+self.lineEdit_39.text()+"', '"+self.label_96.text()+"', '"+self.lineEdit_40.text()+"', '"+self.label_99.text()+"', '"+str(self.comboBox_2.currentText())+"', '"+str(self.comboBox_3.currentText())+"')")
                                cursor.execute("UPDATE GLOBAL_VAR SET TEST_ID='"+str(int(self.label_12.text()))+"'")
                                cursor.execute("UPDATE TEST_MST SET SPECIMEN_NAME = '"+str(self.comboBox_4.currentText())+"', JOB_NAME = '"+str(self.lineEdit_15.text())+"', BATCH_ID = '"+str(self.lineEdit_16.text())+"', MOTOR_SPEED = '"+str(self.lineEdit_9.text())+"', MOTOR_REV_SPEED = '"+str(self.lineEdit_10.text())+"', LENGTH = '"+str(self.lineEdit_12.text())+"', GRAPH_SCAL_Y_LOAD='"+self.lineEdit_14.text()+"', GRAPH_SCAL_X_LENGTH='"+self.lineEdit_13.text()+"', PRE_LOAD ='"+str(self.lineEdit_11.text())+"', WIDTH ='"+str(self.lineEdit_18.text())+"', THICKNESS ='"+str(self.lineEdit_17.text())+"'  WHERE  TEST_ID = '"+str(int(self.label_12.text()))+"'")            
                                cursor.execute("UPDATE SPECIMEN_MST SET  LAST_UNIT_LOAD = '"+str(self.comboBox_2.currentText())+"', LAST_UNIT_DISP = '"+str(self.comboBox_2.currentText())+"', LOAD_CELL = '"+str(self.lineEdit_19.text())+"', MOTOR_SPEED = '"+str(self.lineEdit_9.text())+"', GUAGE_LENGTH_MM = '"+str(self.lineEdit_12.text())+"', THICKNESS = '"+str(self.lineEdit_17.text())+"', WIDTH = '"+str(self.lineEdit_18.text())+"', REV_MOTOR_SPEED = '"+str(self.lineEdit_10.text())+"', PRE_LOAD = '"+str(self.lineEdit_11.text())+"'  WHERE SPECIMEN_NAME = '"+str(self.comboBox_4.currentText())+"'")
                                if str(self.comboBox_2.currentText()) == "Kg.":
                                        cursor.execute("UPDATE TEST_MST SET GRAPH_SCAL_Y_LOAD = '"+str(self.lineEdit_14.text())+"' WHERE  TEST_ID = '"+str(int(self.label_12.text()))+"' ")
                                else:
    ...
    def show_grid_data(self):
        ...
        if(int(str(self.comboBox.currentText())) == 3):       
                ...
                self.tableWidget.setHorizontalHeaderLabels(['Serial No.','Sample','Thickness \n'+str(self.lineEdit_17.text())+' ( mm )','IFD1 @ '+str(self.lineEdit_37.text())+' % \n ('+str(self.comboBox_2.currentText())+')', 'IFD2 @ '+str(self.lineEdit_38.text())+' % \n ('+str(self.comboBox_2.currentText())+')', 'IFD3 @ '+str(self.lineEdit_39.text())+' % \n ('+str(self.comboBox_2.currentText())+')'])
                ...
                self.tableWidget.setHorizontalHeaderLabels(['Serial No.','Sample','Thickness \n'+str(self.lineEdit_17.text())+' ( mm )','IFD1 @ '+str(self.lineEdit_37.text())+' % \n ('+str(self.comboBox_2.currentText())+')', 'IFD2 @ '+str(self.lineEdit_38.text())+' % \n ('+str(self.comboBox_2.currentText())+')', 'IFD3 @ '+str(self.lineEdit_39.text())+' % \n ('+str(self.comboBox_2.currentText())+')', 'IFD3 @ '+str(self.lineEdit_40.text())+' % \n ('+str(self.comboBox_2.currentText())+')'])
        else:
