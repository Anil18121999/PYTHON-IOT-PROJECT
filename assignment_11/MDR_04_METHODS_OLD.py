...
class mdr_04_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_2.setGeometry(QtCore.QRect(20, 400, 1281, 301))
    ...
    def c_fetch_data_from_tw(self):        
        ...
        if(row != -1 ):
            ...
            self.lineEdit.setText(str(self.tableWidget.item(row, 1).text())) #Method Name lineEdit_2
            self.method_name=str(self.tableWidget.item(row, 1).text())
            self.lineEdit_11.setText(str(self.tableWidget.item(row, 2).text())) #Spec.Num lineEdit
            self.lineEdit_2.setText(str(self.tableWidget.item(row, 3).text())) #Max. Torq lineEdit_3
            self.lineEdit_3.setText(str(self.tableWidget.item(row, 4).text())) #Max. Temp lineEdit_4
            self.lineEdit_4.setText(str(self.tableWidget.item(row, 5).text())) #Time lineEdit_5
            self.lineEdit_5.setText(str(self.tableWidget.item(row, 6).text())) # Arc lineEdit_6           
