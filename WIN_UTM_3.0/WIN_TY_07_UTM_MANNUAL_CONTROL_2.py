...
#         self.toolButton.setIconSize(QtCore.QSize(70, 141))
    ...
    def get_USB_0_DEVICE(self):
        ...
        os.system("udevadm info COM1 | grep PL2303 >> lsusb_USB0.txt")
        try:
        ...
        if(port_type == "ERROR"):
                ...
                #### Check For Modbus ########
                os.system("udevadm info COM1 | grep Future >> lsusb_USB0.txt")
                try:
                   f = open('lsusb_USB0.txt','r')
                   for line in f:
                       cnt=0                
    ...
    def load_modbus_port(self):
        ...
        for x in results:
                   if(str(x[0]) == 'Y'):                       
                        ...
                        if(self.port == "C"):
                             self.non_modbus_port="COM1"
                        elif(self.port == "M"):
                             self.modbus_port="COM1"
                        else:                             
                             print("Error 468")  
